                ...
                <div class="p-6 bg-white border-b border-gray-200 sm:px-20">
                    ...
                    >
                        ...
                        <div class="w-full form-control">
                            ...
                            <div class="flex items-center w-20 min-w-full space-x-2">
                                <x-pixonui.form.input type="date" for="fecha_inicio_carga_planificaciones" name="fecha_inicio_carga_planificaciones" required value="{{ old('fecha_inicio_carga_planificaciones', optional($periodoLectivo->fecha_inicio_carga_planificaciones)->format('Y-m-d')) }}"></x-pixonui.form.input>
                            </div>
                        ...
                        <div class="w-full form-control">
                            ...
                            <div class="flex items-center w-20 min-w-full space-x-2">
                                <x-pixonui.form.input type="date" for="fecha_fin_carga_planificaciones" name="fecha_fin_carga_planificaciones" required value="{{ old('fecha_fin_carga_planificaciones', optional($periodoLectivo->fecha_fin_carga_planificaciones)->format('Y-m-d')) }}"></x-pixonui.form.input>
                            </div>
                        ...
                        <div class="w-full form-control">
                            ...
                            <div class="flex items-center w-20 min-w-full space-x-2">
                                <x-pixonui.form.input type="date" for="fecha_inicio_carga_memorias" name="fecha_inicio_carga_memorias" required value="{{ old('fecha_inicio_carga_memorias', optional($periodoLectivo->fecha_inicio_carga_memorias)->format('Y-m-d')) }}"></x-pixonui.form.input>
                            </div>
                        ...
                        <div class="w-full form-control">
                            ...
                            <div class="flex items-center w-20 min-w-full space-x-2">
                                <x-pixonui.form.input type="date" for="fecha_fin_carga_memorias" name="fecha_fin_carga_memorias" required value="{{ old('fecha_fin_carga_memorias', optional($periodoLectivo->fecha_fin_carga_memorias)->format('Y-m-d')) }}"></x-pixonui.form.input>
                            </div>
