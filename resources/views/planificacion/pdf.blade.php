        ...
        <div class="overflow-hidden bg-white sm:rounded-lg">
            <div class="print-p-0 space-y-2 border-b border-gray-200 bg-white p-6 sm:px-20">
                ...
                @if ($planificacion->materiaPlanEstudio->materia->tipo_materia == 'G')
                    <x-pixonui.show.labeltext caption="Nombre de la materia electiva">
                        {{ $planificacion->electiva_nombre }}
                    </x-pixonui.show.labeltext>
                @endif
                <x-pixonui.show.labeltext caption="Tipo de asignatura">
                    {{ $planificacion->tipoAsignatura != null ? $planificacion->tipoAsignatura->nombre : '' }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Modalidad de dictado teoricas">
                    {{ $planificacion->modalidadDictadoTeorica != null ? $planificacion->modalidadDictadoTeorica->nombre : '' }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Modalidad de dictado practicas">
                    {{ $planificacion->modalidadDictadoPractica != null ? $planificacion->modalidadDictadoPractica->nombre : '' }}
                </x-pixonui.show.labeltext>
                ...
                <x-pixonui.show.labeltext caption="Total de horas teóricas">
                    {{ $planificacion->carga_horaria_semanal_teorica }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Total de horas teórica-práctica">
                    {{ $planificacion->carga_horaria_semanal_practica_teorica }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Total de horas prácticas">
                    {{ $planificacion->carga_horaria_semanal_practica }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Suma de carga horaria (teóricas + teórico-prácticas + prácticas)">
                    {{ $planificacion->carga_horaria_semanal_practica + $planificacion->carga_horaria_semanal_practica_teorica + $planificacion->carga_horaria_semanal_teorica }}
                </x-pixonui.show.labeltext>
                ...
                <x-pixonui.show.labeltext caption="Cantidad de parciales previstos">
                    {{ $planificacion->cantidad_parciales }}
                </x-pixonui.show.labeltext>
                <x-pixonui.show.labeltext caption="Modalidad prevista para los parciales">
                    {{ $planificacion->modalidadParcial != null ? $planificacion->modalidadParcial->nombre : '' }}
                </x-pixonui.show.labeltext>
                ...
                @if ($planificacion->salida_campo)
                    <x-pixonui.show.labeltext caption="Correo de contacto del responsable de viaje">
                        {{ $planificacion->correo_responsable_viaje }}
                    </x-pixonui.show.labeltext>
                @endif
                ...
                @if ($planificacion->urlprograma != null)
                    <p>
                        Programa: <a href="{{ asset($planificacion->urlprograma) }}">{{ asset($planificacion->urlprograma) }}</a>
                    </p>
                @endif

                @if (!empty($planificacion->cv_externo))
                    <x-pixonui.heading.h2 class="pt-8">CV Docente Externo</x-pixonui.heading.h2>
                    @foreach ($planificacion->cv_externo as $rutaCv)
                        <p>
                            CV docente externo: <a href="{{ asset($rutaCv) }}">{{ asset($rutaCv) }}</a>
                        </p>
                    @endforeach
                @endif
            </div>
